<?php
	$this->Html->script('Assets.form.upload', ['block' => 'scripts']);
...
?>
	...
	<div class="input select"><label for="<?php echo $id; ?>"><?php echo Inflector::humanize($field); ?></label></div>
	
	<div class="assetfile-block well">
		<div class="preview <?php if(!empty($imagePath)) {echo "has-file";} ?>" style="background-image: url('<?php echo $imagePath; ?>');"></div>
